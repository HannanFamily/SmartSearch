...
EH: LogErrorLocal "PerformSearch", Err.Number, Err.DESCRIPTION: Resume CleanExit
End Sub
...
Public Sub Safe_OutputAllVisible()
    ...
    OutputAllVisible
CleanExit: gBusy = False: Exit Sub
EH: LogErrorLocal "OutputAllVisible", Err.Number, Err.DESCRIPTION: Resume CleanExit
End Sub
